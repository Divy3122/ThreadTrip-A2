...
Error messages: Written for the human in the domain context, not for a developer (see Section 3 below)
...
5	Git Repository(some reqs. are optional)	GitHub or GitLab link	Branching, meaningful commits, README
